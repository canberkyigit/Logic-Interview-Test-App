...
const set2: Question[] = [
  {
    ...
    intro: "Aşağıdaki dizide yalnızca bir sayı örüntüyü bozmaktadır.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "Dizideki artışlar belirli bir matematiksel düzen izlemektedir.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "İşlemler iki farklı kurala göre dönüşümlü yapılmaktadır.",
  ...
  },
  {
    ...
    intro: "Her satır aynı matematiksel kuralla oluşturulmuştur.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "Tek ve çift sıradaki sayılar kendi içlerinde ayrı örüntüler oluşturur.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "Sayılar arasındaki farklar sistematik biçimde ilerlemektedir.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "Her adımın artışı belirli bir matematiksel örüntü izlemektedir.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "Toplama ve çarpma işlemleri artan sayılarla dönüşümlü ilerlemektedir.",
  ...
  },
  {
    ...
    kind: "sequence",
    category: "Sayısal örüntü - düzeni bozan sayı",
    intro: "Toplama ve çarpma işlemleri sırayla uygulanmaktadır.",
