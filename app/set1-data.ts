...
export const set1: Question[] = [
  ...
  { id: 3, kind: "sequence", category: "Sayı dizisi", sequence: "92 - 46 - 48 - 24 - 26 - ?", prompt: "Sıradaki sayı hangisidir?", options: ["11", "12", "13", "14", "15"], answer: 2, explanation: "İşlemler sırayla ikiye bölme ve 2 ekleme biçimindedir: 26 ÷ 2 = 13." },
